---
name: vaspilot
description: Automate VASP calculations on HPC—structure creation, input generation (INCAR/KPOINTS/POSCAR/gen_potcar.sh), optional remote submit and result parsing. Use when the user needs to create crystal structures, generate VASP inputs locally, or run relaxation/scf/band workflows.
metadata:
  tools: "vaspilot_create_structure, vaspilot_load_structure, vaspilot_analyze_structure, vaspilot_generate_inputs"
---
